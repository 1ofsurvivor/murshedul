...
<html lang="en" data-safeMod="false" data-autoHideScrollbar="true" data-safeModPageInAnimation="fadeIn" data-inAnimation="fadeInUp" data-outAnimation="fadeOutDownBig" data-cover-h1-tune=".85" data-cover-h2-tune="2.3" data-cover-h3-tune=".6" data-cover-h3-span-tune=".8" data-twitter-name="pixelwarsdesign">
    ...
    <head>
        ...
        <meta name="description" content="Murshedul - Web Consultant">
        <meta name="keywords" content="murshedul, web consultant, web director, web site developer">
        <meta name="author" content="Murshedul">
        
        <title>Murshedul - Web Consultant, Director, Developer</title> 
        ...
        <link class="cover-skin" rel="stylesheet" type="text/css" href="css/skins/cover/retro.css">
        <link class="base-skin" rel="stylesheet" type="text/css" href="css/skins/base/clean.css">
        <link class="paper-bg-skin" rel="stylesheet" type="text/css" href="css/skins/paper-bg/rice-paper.css">
        <link class="body-bg-skin" rel="stylesheet" type="text/css" href="css/skins/body-bg/noisy-net.css">
                            ...
                            <div class="antiscroll-wrap">
                                ...
                                <div class="antiscroll-inner">
                                    ...
                                    <div class="cover">
                                        ...
                                        <!-- slogan -->
                                        <h2>Web Consultant & Bridge Engineer</h2>
                                        <!-- slogan -->
                                        
                                        <!-- extra titles -->
                                        <h3><span>I AM FROM</span> Japan</h3>
                                        <h3><span>WI CREATE</span> Web/Mobile Site & Apps</h3>
                                        <h3><span>I LIKE</span> minimalistic design</h3>
                                        <h3><span>CONTRACT</span> Available</h3>
                                        <!-- extra titles --
                                        ...
                                        <div class="latest-from-blog">
                                            ...
                                            <div class="blog-bar">
                                            	<h2><a href="blog-single.html">Configure Apache Server on CentOS 8</a></h2>
                                            </div>
                                        </div>
                                        <!-- latest-from-blog -->
                            ...
                            <div class="antiscroll-wrap">
                                ...
                                <div class="antiscroll-inner">
                                        ...
                                        <div class="content">
                                            ...
                                            <h4 class="about-text">
                                                I am a <span class="label">Web Consultant & SE Bridge Engineer</span> 
                                        ...
                                        <div class="content">
                                            ...
                                            <div class="portfolio-items">
                                              ...
                                              <div class="coding hentry">
                                                ...
                                                <p class="category">illustration by Dave Mottram</p>
                                              </div>
                                              <!-- portfolio-item --> 
                                              
                                              
                                              <!-- portfolio-item - lightbox video -->  
                                              <div class="coding video hentry">
                                                <div class="media-box">
                                              ...
                                              <div class="logo image hentry">
                                                ...
                                                <p class="category">Web Design, UI Design</p>
                                              </div>
                                              <!-- portfolio-item - lightbox gallery -->
                                              
                                              
                                              <!-- portfolio-item - custom url -->  
                                              <div class="logo url hentry">
                                                <div class="media-box">
                                                ...
                                                <p class="category">illustration / sketch</p>
                                              </div>
                                              <!-- portfolio-item - custom url -->
                                              ...
                                              <div class="contact-form">
                                                ...
                                                <div class="letter cf">
                                                    ...
                                                    <div class="letter-info">
                                                    	<h4>Murshedul Hoque</h4>
                                                        <p><a href="#"><i>rasedhasan188@gmail.com</i></a></p>
                                                        <p> - From Tokyo, Japan, Earth</p>
                                                    </div>
...
<?php
    /*Mail functioning*/
    $sendTo = "rasedhasan188@gmail.com";
    // GET Data from the Mail Form
    $name = $_POST['name'];
    if ($_POST['email'] != $sendTo) {
        $email = $_POST['email'];
    }
